...
| <a name="input_enable_irsa"></a> [enable\_irsa](#input\_enable\_irsa) | (optional) Whether to use IRSA module for helm release deployment or not? If set to false then all IRSA module resources are disabled. | `bool` | `false` | no |
